 ...
 * as a column value in a row of a ExamplesAndReferences.database table. The driver implements Blob using an SQL locator(BLOB), which means that a Blob object contains a logical
